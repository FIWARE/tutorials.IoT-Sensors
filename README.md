...
as sent to the IoT Agent can be seen on the device monitor page.
...
process the measure. However this measure is the class of request generated by all JSON. sensors.
